 ...
 * @author Mercadeo 1
 */
public class MaterialAlumnosFrame extends javax.swing.JFrame {
 ...
 private void cargarTodosLosEjemplares() {
  ...
  private void buscarPorTipo(String tipo) {
    ...
    /**
     * Creates new form MaterialAlumnosFrame
     */
    public MaterialAlumnosFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaterialAlumnosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
