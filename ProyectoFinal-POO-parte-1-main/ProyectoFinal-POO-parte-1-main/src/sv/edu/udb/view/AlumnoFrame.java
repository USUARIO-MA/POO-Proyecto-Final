...
public class AlumnoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnMoras = new javax.swing.JButton();
        ...
        btnPrestamos.setText("Tus Prestamos");
        ...
        btnMoras.setText("Consultar Moras");
        btnMoras.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMorasActionPerformed(evt);
            }
        });
    ...
    private void btnMorasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMorasActionPerformed
       new MorasAlumnoFrame().setVisible(true);
        dispose();        // TODO add your handling code here:
    }//GEN-LAST:event_btnMorasActionPerformed

    private void btnMaterialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaterialActionPerformed
        new MaterialAlumnosFrame().setVisible(true);     
                dispose();// TODO add your handling code here:
    ...
    private javax.swing.JButton btnMoras;
